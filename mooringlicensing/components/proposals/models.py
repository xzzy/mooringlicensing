...
##reversion.register(VesselDetails, follow=['feeitemapplicationfee_set'])
...
reversion.register(VesselDetails)
reversion.register(CompanyOwnership)
reversion.register(VesselOwnership)
