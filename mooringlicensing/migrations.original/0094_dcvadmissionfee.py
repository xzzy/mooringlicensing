# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2021-04-22 06:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('mooringlicensing', '0093_dcvadmission'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='created_by_dcv_admission_fee', to=settings.AUTH_USER_MODEL)),
