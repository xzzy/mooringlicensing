...
router.register(r'dcv_permit', mooringlicensing.components.approvals.api.DcvPermitViewSet, 'dcv_permit')
router.register(r'dcv_admission', mooringlicensing.components.approvals.api.DcvAdmissionViewSet, 'dcv_admission')
