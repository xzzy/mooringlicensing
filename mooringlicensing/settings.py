...
PAYMENT_SYSTEM_PREFIX = env('PAYMENT_INTERFACE_SYSTEM_PROJECT_CODE', 'PAYMENT_INTERFACE_SYSTEM_PROJECT_CODE not configured')
PS_PAYMENT_SYSTEM_ID = PAYMENT_SYSTEM_PREFIX.replace('0', 'S')
