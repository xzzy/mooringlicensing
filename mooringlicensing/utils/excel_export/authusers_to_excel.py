...
APPROVAL_FIELDS = [
    ...
    #'approval__mooringonapproval_set',
]
...
def write():
    """
        from mooringlicensing.utils.excel_export.authusers_to_excel import write
        df = write()
    """
...
def get_fields(model):
    """
        from mooringlicensing.utils.excel_export.authusers_to_excel import get_fields
